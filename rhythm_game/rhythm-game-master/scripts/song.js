var s = {
  ...
  notes: [
    ...
    { duration: 3, delay: 4.8 },
    { duration: 3, delay: 5.2 },
    { duration: 3, delay: 5.7 },
    { duration: 3, delay: 5.9 },
    { duration: 3, delay: 6.1 },
    { duration: 3, delay: 6.3 },
    { duration: 3, delay: 6.5 },
    { duration: 3, delay: 6.7 },
    { duration: 3, delay: 6.8 },
    { duration: 3, delay: 7 },
    { duration: 3, delay: 7.3 },
    { duration: 3, delay: 7.6 },
    { duration: 3, delay: 7.8 },
    { duration: 3, delay: 7.9 },
    { duration: 3, delay: 8 },
    { duration: 3, delay: 8.1 },
    { duration: 3, delay: 8.15 },
    { duration: 3, delay: 8.4 },
    { duration: 3, delay: 8.7 },
    { duration: 3, delay: 8.8 },
    { duration: 3, delay: 8.9 },
    { duration: 3, delay: 9 },
    { duration: 3, delay: 10 },
    { duration: 3, delay: 12 },
    { duration: 3, delay: 12.1 },
